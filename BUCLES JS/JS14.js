//function operadoresLogicos(num1, num2, num3) {
  ...
  function operadoresLogicos(num1, num2, num3) {
    // Define un array para verificar si hay números negativos
    const numeros = [num1, num2, num3];
  
    // Recorre el array para verificar si hay números negativos
    ...
    // Verifica si num1 es mayor que num2 y num3, y si es positivo
    if (num1 > num2 && num1 > num3 && num1 > 0) {
      return "Numero 1 es mayor y positivo";
    }
  
    // Verifica si num3 es más grande que num1 y num2, y aumenta su valor en 1
    if (num3 > num1 && num3 > num2) {
      return num3 + 1;
    }
  
    // Si ninguna de las condiciones anteriores se cumple, retorna false
    return false;
  }
